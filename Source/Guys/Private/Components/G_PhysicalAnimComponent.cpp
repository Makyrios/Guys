...
void UG_PhysicalAnimComponent::TogglePhysicalAnimation(float RevertAnimDelay)
{
    if (SkeletalMeshComponent && PhysicalAnimComponent)
    {
        ...
        PhysicalAnimComponent->SetStrengthMultiplyer(100.0f);
        ...
        GetOwner()->GetWorldTimerManager().SetTimer(
            TogglePhysicsTimer, [this]() { SkeletalMeshComponent->SetAllBodiesBelowSimulatePhysics(SimulationBone, false, false); },
            RevertAnimDelay, false);
    }
}
